...
const config: QuartzConfig = {
  configuration: {
    pageTitle: "THE FINALS Easter Eggs",
    pageTitleSuffix: " - THE FINALS Easter Eggs",
    enableSPA: true,
    enablePopovers: true,
    analytics: {
      provider: "plausible",
  ...
  plugins: {
    ...
    emitters: [
      ...
      Plugin.CustomOgImages({
        ...
        height: 500, // height to generate with (in pixels)
